...
We have [Participation Guidelines](./participation-guidelines.md) that apply to all the activities related to this project.
...
For more detailed instructions on How to contribute, and guiding tutorials, please check out *[THIS](https://hackmd.io/1rOVdqk0RzOseN-Dj9pr4A#Setting-up-the-Knowledge-Base)*.
...
The use of this space and resources, including policy on collected data are subject to [The Alan Turing policies](https://www.turing.ac.uk/)
